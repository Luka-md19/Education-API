...
console.log("Connecting to MongoDB for commAnsData import...");
...
mongoose
  ...
  .then(() => console.log("DB connection successful for commAnsData import!"))
  .catch((err) => {
...
if (process.argv[2] === "--import-community-feeds") {
